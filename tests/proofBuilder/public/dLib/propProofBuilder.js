...
import { SVGElt, SVGGrpElt, SelectableTextList, SVGSelectableText, SVGText, textWidth, SVGTSpan } from '../clientLib/svgElt.js';
import { PXE } from '../clientLib/pxe.js';
...
export class ProofBuilderDemo extends SVGElt {
    ...
    constructor(width, height) {
        ...
        this.hList = [];
        this.iList = [];
        this.opWidgets = { widgets: [], choice: -1 };
        this.eiWidgets = { widgets: [], choice: -1 };
        this.sideWidgets = { widgets: [], choice: -1 };
        this.hypotheticals = [];
        this.closedHypotheticals = [];
        pb = this;
...
//# sourceMappingURL=propProofBuilder.js.map