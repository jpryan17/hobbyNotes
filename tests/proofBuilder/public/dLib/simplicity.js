import { setExp, setVal, compareExps, expToId } from './exputils.js';
...
//
let simtree;
export function initSimtree(id) {
...
export class SimplicityDiagram extends SVGElt {
    ...
    constructor() {
        ...
        this.leftNodeColor = 'red';
        this.rightNodeColor = 'blue';
        that = this;
        this.tree = new InteractiveTree(this, 'simplicity', this.treeWidth, this.treeHeight, this.treeMaxBD, this.treeNodeSize, { bottomRoom: 75 }, 1, processSelection);
