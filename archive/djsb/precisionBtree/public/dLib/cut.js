...
//
let cutTree;
export function initCutTree(id) {
...
export class CutDiagram extends SVGElt {
    ...
    constructor() {
        ...
        this.nodeSize = 6;
        that = this;
        this.tree = new InteractiveTree(this, 'cut', this.treeWidth, this.treeHeight, this.maxBD, this.nodeSize, { antenna: true, topRoom: 30 }, 2, process, init, middle, true);
