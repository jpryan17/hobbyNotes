...
export class SVGSelectableText extends SVGText {
    constructor(cb, text, enabled = true, id, color) {
        super(id);
        this.color = { std: 'darkblue', over: 'purple', disabled: 'grey', selected: 'darkred' };
        if (color)
            this.color = color;
...
export class SelectableTextList extends SVGElt {
    ...
    constructor(cb, stl) {
        ...
        this.maxLineCharCnt = 50;
        this.fontSize = 16;
        this.disabledColor = 'grey';
        this.bgColor = 'beige';
        this.baseColor = 'black';
        this.overColor = 'purple';
        this.frameColor = 'darkblue';
        this.frameWidth = 1;
        this.id = '';
        //
        this.margin = 5;
        this.arrowRectWidth = 25;
        //
        this.list = [];
        if (stl) {
