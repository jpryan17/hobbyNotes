import { findCut, keyToExp, expToId, setVal } from '../../../clientLib/exputils.js';
...
console.assert(updatedContent.includes('<btd-ref mode="cut">Conway Cut Demo</btd-ref>'), '<<BTD mode="cut">> conversion failed');
console.assert(updatedContent.includes('<btd-ref mode="birthday">Birthday Levels</btd-ref>'), '\\btd conversion failed');
