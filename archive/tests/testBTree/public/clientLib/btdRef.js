...
export class BTDRef extends HTMLElement {
    ...
    connectedCallback() {
        this.setAttribute('style', `color:${BTDRef.stdColor};font-weight:bold;cursor:pointer;text-decoration:underline;text-underline-offset:3px;`);
        this.addEventListener('mouseover', () => {
            this.setAttribute('style', `color:${BTDRef.overColor};font-weight:bold;cursor:pointer;text-decoration:underline;text-underline-offset:3px;`);
        });
        this.addEventListener('mouseout', () => {
            this.setAttribute('style', `color:${BTDRef.stdColor};font-weight:bold;cursor:pointer;text-decoration:underline;text-underline-offset:3px;`);
        });
        this.addEventListener('click', () => {
            const mode = this.getAttribute('mode') || 'plain';
