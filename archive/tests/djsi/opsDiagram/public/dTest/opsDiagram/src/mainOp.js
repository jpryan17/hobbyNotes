...
const tree = new InteractiveTree('op', 1000, 500, 6, 6, 2, processCB, initCB, middleCB);
const dh = 1000;
    ...
    function showResult() {
        ...
        if (RsOps.bailed) {
            ...
            if (opExp.length <= tree.nodeSize) {
                ...
                let opNode = getElementByIdOrKey(opVal);
...
function getElementByIdOrKey(idOrKey) {
...
function setColors(left, right, result) {
...
function setOpControls() {
    ...
    const maxOpsButton = document.createElement('button');
    ...
    const maxOpsTextAbortButton = document.createElement('button');
    ...
    ms === null || ms === void 0 ? void 0 : ms.appendChild(controls.elt);
...
//# sourceMappingURL=mainOp.js.map