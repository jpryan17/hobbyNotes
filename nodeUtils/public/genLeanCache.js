...
exports.generateLeanCache = generateLeanCache;
...
function getLeanVersion(leanBin) {
    try {
        const res = (0, child_process_1.spawnSync)(leanBin, ['--version'], { encoding: 'utf8' });
...
function verifySnippetWithLean(leanBin, snippet, includeScaffold = true) {
    ...
    const res = (0, child_process_1.spawnSync)(leanBin, [tempFile], { encoding: 'utf8', timeout: 8000 });
...
function generateLeanCache(force = false) {
    ...
    try {
        ...
        if (fs.existsSync(scaffoldPath))
            h.update(fs.readFileSync(scaffoldPath));
