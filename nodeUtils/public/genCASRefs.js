...
exports.convertCASRefContent = convertCASRefContent;
exports.processCASRefFile = processCASRefFile;
const fs_1 = require("fs");
const path_1 = require("path");
/**
 * Converts <<CAS calc-id="..." ...>>...<<\>> or \cas{calcId}{text} into <cas-ref calc-id="...">...</cas-ref>
 */
function convertCASRefContent(content) {
...
function processCASRefFile(filePath) {
