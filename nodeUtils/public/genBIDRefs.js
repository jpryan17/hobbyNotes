...
exports.convertBIDRefContent = convertBIDRefContent;
exports.processBIDRefFile = processBIDRefFile;
const fs_1 = require("fs");
const path_1 = require("path");
/**
 * Converts <<BID mode="..." ...>>...<<\>> or \bid{mode}{text} into <bid-ref mode="...">...</bid-ref>
 */
function convertBIDRefContent(content) {
...
function processBIDRefFile(filePath) {
