...
exports.formatExp = formatExp;
exports.normalizeToInternalExp = normalizeToInternalExp;
exports.validateExp = validateExp;
exports.convertTTDRefContent = convertTTDRefContent;
exports.processTTDRefFile = processTTDRefFile;
...
function normalizeToInternalExp(str) {
...
function convertTTDRefContent(content) {
...
function processTTDRefFile(filePath) {
    ...
    try {
        ...
        if (replacementsCount > 0) {
            (0, fs_1.writeFileSync)(filePath, updatedContent);
