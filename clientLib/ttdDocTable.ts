...
export class TTDDocTable extends Elt{
    charTokens:[string,number][] = [['p',0x1d45d],['q',0x1d45e],['r',0x1d45f],['s',0x1d460],
                                    ['[',0x005b],[']',0x005d],['n',0x00ac],
                                    ['a',0x2227],['o',0x2228],['i',0x2192],['e',0x2194]]
    charset = this.charTokens.map(e=>e[0])
    tokenset = this.charTokens.map(e=>String.fromCodePoint(e[1]))
    //
    constructor(){
        super('table')
        this.setTable()
    ...
    setStyle(elts:Elt|Elt[],styleSet:number,span?:number){
