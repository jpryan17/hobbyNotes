...
export class CasDemo extends Elt {
  ...
  constructor() {
    ...
    this.elt.setAttribute(
      'style',
      'box-sizing: border-box; width: 100%; min-height: 100%; padding: 20px 24px; background: #f8fafc; font-family: system-ui, -apple-system, sans-serif;'
    );
    ...
    header.setAttribute(
      'style',
      'display: flex; justify-content: space-between; align-items: center; padding: 14px 20px; background: #0f172a; color: #ffffff;'
    );
    header.innerHTML = `
