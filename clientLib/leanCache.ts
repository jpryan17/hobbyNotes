// Auto-generated by nodeUtils/genLeanCache.ts on 2026-09-25T04:04:20.472Z
...
export const LEAN_CACHE: Record<string, LeanCacheEntry> = {
  "telescoping_ftc": {
    ...
    "verifiedAt": "2026-09-25T04:04:20.472Z",
  ...
  "∫[a, b] f(x) dx = st( ∑_{k=1}^{ω} f(x_k) · dx )": {
    "key": "hyper_sum",
    "target": "scaffold:hyper_sum",
    "expression": "∫[a, b] f(x) dx = st( ∑_{k=1}^{ω} f(x_k) · dx )",
    "signature": "def hyper_sum (f : Nat → R_w) : Nat → R_w",
  ...
  "Δ²f(x) = f(x - dx) - 2f(x) + f(x + dx)  ∧  f''(x) = st( Δ²f(x) / dx² )": {
    "key": "discrete_curvature",
    "target": "scaffold:discrete_curvature",
    "expression": "Δ²f(x) = f(x - dx) - 2f(x) + f(x + dx)  ∧  f''(x) = st( Δ²f(x) / dx² )",
    "signature": "def delta2 & axiom second_derivative_shadow",
  ...
  "d ↦ angle_to_rotor(2π · d.val) ∈ UnitRotor": {
    "key": "dyadic_to_rotor",
    "target": "scaffold:dyadic_to_rotor",
    "expression": "d ↦ angle_to_rotor(2π · d.val) ∈ UnitRotor",
    "signature": "def dyadic_to_rotor (d : D_w) : UnitRotor",
