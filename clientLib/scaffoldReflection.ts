...
export interface ScaffoldEntry {
  ...
  checks: { label: string; question: string; passed: boolean; detail?: string }[];
...
export function getScaffoldReflection(scaffoldId: string, fallbackTitle?: string): FormalArgument {
