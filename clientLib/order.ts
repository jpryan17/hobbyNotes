...
let orderedtree:OrderedDiagram

export function initOrderedtree(id:string){
...
export class OrderedDiagram extends SVGElt{
    ...
    constructor(){
        super('svg')
        that=this
        this.tree = new InteractiveTree(this,'ordered',
            this.treeWidth,this.treeHeight,this.treeMaxBD,this.treeNodeSize,
            {bottomRoom:25},1,processSelection)
