...
export class ArgumentCard extends Elt {
  ...
  private options?: ArgumentCardOptions;
  private statusPill: Elt;
  private footerNotice: Elt;
  private verifyBtn?: Elt;
  private studioBtn?: Elt;
  private calcBtn?: Elt;
  private calcContainer?: Elt;
  private calculatorInstance?: FsCalculator;
  private isCalcOpen = false;

  constructor(arg: FormalArgument, options?: ArgumentCardOptions) {
    super("div");
    this.arg = arg;
    ...
    this.studioBtn.setA(
      "style",
      "display: none; padding: 3px 9px; font-size: 11px; font-weight: 600; cursor: pointer; border: 1px solid #7c3aed; background: #7c3aed; color: #ffffff; border-radius: 4px; transition: all 0.15s ease;"
    );
  ...
  private async detectEnvironment() {
    ...
    const isDev =
      isLocal ||
      (typeof Nav !== "undefined" && Boolean((Nav as any).edit));
    ...
    if (this.studioBtn) {
      this.studioBtn.setA(
        "style",
        "display: inline-block; padding: 3px 9px; font-size: 11px; font-weight: 600; cursor: pointer; border: 1px solid #7c3aed; background: #7c3aed; color: #ffffff; border-radius: 4px; transition: all 0.15s ease;"
      );
    }
  ...
  private setServerOffline(cached?: LeanCacheEntry) {
    ...
    if (this.studioBtn) {
      this.studioBtn.setA(
        "style",
        "display: inline-block; padding: 3px 9px; font-size: 11px; font-weight: 600; cursor: pointer; border: 1px solid #7c3aed; background: #7c3aed; color: #ffffff; border-radius: 4px;"
      );
    }
    if (this.calcBtn) {
      this.calcBtn.setA(
    ...
    if (cached) {
      ...
      if (this.verifyBtn) {
        this.verifyBtn.setA(
          "style",
          "display: inline-block; padding: 3px 9px; font-size: 11px; font-weight: 600; cursor: pointer; border: 1px solid #94a3b8; background: #94a3b8; color: #ffffff; border-radius: 4px;"
        );
  ...
  private toggleCalculator(presetKey?: string, activeModeId?: string) {
