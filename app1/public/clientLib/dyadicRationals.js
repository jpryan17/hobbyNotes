...
export class DR {
    ...
    numerator = 0;
    precision = 0;
    constructor(signSequence, sign, num, prec) {
    ...
    static shift(a, k) {
        if (!a.sign || a.numerator === 0)
            return new DR();
        if (k === 0)
            return new DR(undefined, a.sign, a.numerator, a.precision);
        if (k > 0) {
            if (a.precision >= k) {
